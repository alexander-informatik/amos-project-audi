...
privileged aspect Taskdb_Roo_Jpa_Entity {
    
    declare @type: Taskdb: @Entity;
    
    @Id
    @GeneratedValue(strategy = GenerationType.AUTO)
    @Column(name = "id")
    private Long Taskdb.id;
    
    @Version
    @Column(name = "version")
    private Integer Taskdb.version;
    
    public Long Taskdb.getId() {
        return this.id;
    }
    
    public void Taskdb.setId(Long id) {
        this.id = id;
    }
    
    public Integer Taskdb.getVersion() {
        return this.version;
    }
    
    public void Taskdb.setVersion(Integer version) {
