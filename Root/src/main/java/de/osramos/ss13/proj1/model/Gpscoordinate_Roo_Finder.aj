...
privileged aspect Gpscoordinate_Roo_Finder {
    
    public static TypedQuery<Gpscoordinate> Gpscoordinate.findGpscoordinatesByRoute(Route route) {
        ...
        TypedQuery<Gpscoordinate> q = em.createQuery("SELECT o FROM Gpscoordinate AS o WHERE o.route = :route", Gpscoordinate.class);
